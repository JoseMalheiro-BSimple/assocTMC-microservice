...
public class CreateTests
{
    ...
    public async Task Create_WhenValidInput_ReturnsSuccessResultAndPublishesMessage()
    {
        ...
        _repoMock.Setup(r => r.AddWithoutSavingAsync(It.IsAny<IAssociationTrainingModuleCollaborator>()))
            .Returns(mockEntity.Object);

        _repoMock.Setup(d => d.SaveChangesAsync()).ReturnsAsync(1);
        ...
        _repoMock.Verify(r => r.AddWithoutSavingAsync(It.Is<IAssociationTrainingModuleCollaborator>(a => a == mockEntity.Object)), Times.Once);
        _publisherMock.Verify(p => p.PublishAssociationTrainingModuleCollaboratorCreatedMessage(
            ...
            Times.Once);
        _repoMock.Verify(d => d.SaveChangesAsync(), Times.Once);
    }
    ...
    public async Task Create_WhenPublisherThrowsException_ReturnsInternalServerErrorAndDoesNotSave()
    {
        ...
        _repoMock
            .Setup(r => r.AddWithoutSavingAsync(It.IsAny<IAssociationTrainingModuleCollaborator>()))
            .Returns(mockEntity.Object);
        ...
        _factoryMock.Verify(f => f.Create(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<DateOnly>(), It.IsAny<DateOnly>()), Times.Once);
        _repoMock.Verify(r => r.AddWithoutSavingAsync(It.IsAny<IAssociationTrainingModuleCollaborator>()), Times.Once);
        _publisherMock.Verify(p => p.PublishAssociationTrainingModuleCollaboratorCreatedMessage(
    ...
    [Fact]
    public async Task Create_WhenRepositoryAddWithoutSavingThrowsException_ReturnsInternalServerErrorAndDoesNotPublish()
    {
        // Arrange
        Mock<IAssociationTrainingModuleCollaboratorsRepository> _repoMock = new Mock<IAssociationTrainingModuleCollaboratorsRepository>();
        Mock<IAssociationTrainingModuleCollaboratorFactory> _factoryMock = new Mock<IAssociationTrainingModuleCollaboratorFactory>();
        ...
        _factoryMock.Verify(f => f.Create(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<DateOnly>(), It.IsAny<DateOnly>()), Times.Once);
        _repoMock.Verify(r => r.AddWithoutSavingAsync(It.IsAny<IAssociationTrainingModuleCollaborator>()), Times.Once); // Called and threw
        _publisherMock.Verify(p => p.PublishAssociationTrainingModuleCollaboratorCreatedMessage(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<PeriodDate>()), Times.Never);
        _repoMock.Verify(d => d.SaveChangesAsync(), Times.Never);
    }

    [Fact]
    public async Task Create_WhenRepositorySaveChangesAsyncThrowsException_ReturnsInternalServerError()
    {
        // Arrange
        Mock<IAssociationTrainingModuleCollaboratorsRepository> _repoMock = new Mock<IAssociationTrainingModuleCollaboratorsRepository>();
        Mock<IAssociationTrainingModuleCollaboratorFactory> _factoryMock = new Mock<IAssociationTrainingModuleCollaboratorFactory>();
        ...
        var expectedSaveErrorMessage = "Concurrency conflict during save.";
        _repoMock.Setup(d => d.SaveChangesAsync()).ThrowsAsync(new Exception(expectedSaveErrorMessage));
        ...
        // Assert
        Assert.False(result.IsSuccess);
        Assert.Equal(Error.InternalServerError($"An unexpected error occurred during creation: {expectedSaveErrorMessage}").StatusCode, result.Error?.StatusCode);
